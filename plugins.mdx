...
<CardGroup cols={2}>
  ...
  <Card title="Islandora" icon="layer-group" href="/plugins/isle">
    Islandora workflows from `sitectl-isle v1.0.0`: guided site creation, component and feature-bundle management, Fedora and Blazegraph sync, and migration utilities. Includes the Drupal plugin.
  </Card>

...
- caller workflow: [sitectl `goreleaser.yaml` at the documented v1.0.0 commit](https://github.com/libops/sitectl/blob/65cfde137a58ba14aaa9a1512d88b943888872f3/.github/workflows/goreleaser.yaml)

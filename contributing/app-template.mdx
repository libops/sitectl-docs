...
11. Test a clean create and an upgrade rollout. Migration commands must fail hard, waits must be bounded, and applications without a supported CLI migration must print an explicit operator gate.

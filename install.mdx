...
|---|---|---|
| ArchivesSpace | `sitectl-archivesspace` | [GitHub releases](https://github.com/libops/sitectl-archivesspace/releases) |
| OJS | `sitectl-ojs` | [GitHub releases](https://github.com/libops/sitectl-ojs/releases) |
| Omeka Classic | `sitectl-omeka-classic` | [GitHub releases](https://github.com/libops/sitectl-omeka-classic/releases) |
| Omeka S | `sitectl-omeka-s` | [GitHub releases](https://github.com/libops/sitectl-omeka-s/releases) |
| WordPress | `sitectl-wp` | [GitHub releases](https://github.com/libops/sitectl-wp/releases) |

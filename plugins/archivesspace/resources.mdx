...
These shortcuts accept the same read flags as API requests, including `--url`,
`--session-file`, and repeated `--query name=value` filters. You can also set
`ARCHIVESSPACE_SESSION_FILE` once for a sequence of read commands.

...
description: ArchivesSpace sitectl workflows including template creation, Compose lifecycle commands, REST API helpers, diagnostics, and container script wrappers.
---
...
- [Lifecycle](/plugins/archivesspace/lifecycle) for `build`, `init`, `up`, `down`, `status`, `logs`, and `rollout`

...
Mergepdf is a [feature bundle](/plugins/isle/feature-bundles), not a service-only
topology switch, because its Compose service and Drupal event action must change
together.

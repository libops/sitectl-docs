...
|---|---|---|---|
| `iiif` | `cantaloupe`, `triplet` | `triplet` | Compose services and volumes, `conf/traefik/cantaloupe.yml`, `conf/traefik/triplet.yml`, `conf/triplet/config.yaml`, Drupal's Cantaloupe URL, and `robots.txt` IIIF route hints. |

...
The reviewed v1 set pairs `sitectl-libops v1.3.0` with core `sitectl v1.0.0`. Manual binary installs must keep both binaries aligned; verify with `sitectl --version`, `sitectl-libops --version`, and `sitectl libops --help`.

...
Native packages require core `sitectl` 0.38.0 or newer. Manual binary installs must keep both binaries current; verify with `sitectl --version`, `sitectl-libops --version`, and `sitectl libops --help`.

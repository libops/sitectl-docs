...
| [`mergepdf`, `hocr-search`](/plugins/isle/feature-bundles) | Complete application features across Compose, Drupal config, and Composer where needed. | `sitectl set mergepdf enabled --islandora-tag 6.3.19` or `sitectl set hocr-search enabled --hocr-term-id 56` |

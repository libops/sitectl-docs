...
<Steps>
  ...
  <Step title="Answer component questions">
    sitectl asks about each component that requires a decision at create time — such as whether to include fcrepo, Blazegraph, or bot mitigation. You can answer interactively or pre-supply answers with flags.
  </Step>
...
See [bot-mitigation](/plugins/isle/bot-mitigation) for Turnstile key requirements and the local Traefik plugin source behavior.

...
Use `healthcheck` to verify that the active context's site is up. Core checks confirm
the <Compose /> service containers are running and healthy. If the context's plugin

...
<Steps>
  ...
  <Step title="Inspect or repair drift">
    Use `sitectl converge` after manual edits or an upstream update to inspect component drift and repair only components that are out of alignment. `set` changes do not require this extra step.

...
<Warning>
Do not add `sitectl-isle v0.19.0` to the v1 verification set above. ISLE remains on the separate legacy core `v0.40.0` and Drupal `v0.12.0` record documented in [Install and Upgrade](/install).
</Warning>

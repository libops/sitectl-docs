...
- files under the [repository root](https://github.com/libops/sitectl/tree/main) for the rest of the documentation
...
- keep pages at the root unless the page is the root homepage, which lives at `index.mdx`

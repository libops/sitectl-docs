...
Core `sitectl` owns the operator-facing command shape. Plugins extend that behavior through internal extension commands that are dispatched based on the active context plugin.

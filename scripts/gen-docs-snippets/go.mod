...
require (
	github.com/libops/sitectl v1.9.1
	github.com/libops/sitectl-archivesspace v0.0.0
	github.com/libops/sitectl-drupal v1.5.0
	github.com/libops/sitectl-isle v1.6.0
	github.com/libops/sitectl-libops v1.7.0
	github.com/libops/sitectl-ojs v1.4.0
	github.com/libops/sitectl-omeka-classic v1.4.0
	github.com/libops/sitectl-omeka-s v1.4.0
...
replace (
	...
	github.com/libops/sitectl-omeka-s => ../../../../cli/sitectl-omeka-s
	github.com/libops/sitectl-wp => ../../../../cli/sitectl-wp
)
